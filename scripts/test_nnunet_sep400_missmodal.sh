#!/bin/bash
######## Job Name: Test_Job ########
#SBATCH -J Test_sep400_onlypredictT2FL
#SBATCH -o logs/Test_sep400_onlypredictT2FL.o%j
#SBATCH -e logs/Test_sep400_onlypredictT2FL.e%j
######## Number of nodes: 1 ########
#SBATCH -N 1
#SBATCH -n 1
...
nnUNet_predict -tr nnUNetTrainerV2 -i /scratch/tang.zitian/nnUNet_raw_data_base/nnUNet_raw_data/Task400_BraTS2021/imagesTs -o /scratch/tang.zitian/nnUNet_predictions/sep_T2FL_predictions -t Task400_BraTS2021 -m 3d_fullres --save_npz  -f 1 -p nnUNetPlansv2.1_verybig